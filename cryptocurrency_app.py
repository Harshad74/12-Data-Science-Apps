...
image=Image.open(r'C:\Users\JITENDRA\Desktop\Git\12-Data-Science-Apps\crypto_logo.jpg')
...
currency_price_unit=col1.selectbox('currency price unit',('USD', 'BTC', 'ETH'))
...
def load_data():
    ...
    data=soup.find('script',id='_NEXT_DATA_',type='application/json')
    coins={}
